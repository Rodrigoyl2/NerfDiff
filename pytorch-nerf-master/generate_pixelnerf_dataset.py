...
SHAPENET_DIR = "E:/GitHub/mednerf_drr_dataset/pytorch-nerf-master/ShapeNetCore.v2"
...
def main():
    ...
    random.shuffle(objs)  # Randomize the order of objects
    max_objects = 10  # Limit to 10 objects for a subset

    used_objs = []
    for idx, obj in enumerate(objs):
        if idx >= max_objects:
            break  # Stop after processing max_objects
